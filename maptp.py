...
def from_data_file(filename):
    url = f'https://raw.githubusercontent.com/streamlit/streamlit/develop/examples/data/{filename}'
...
try:
    ...
    st.error(f"ErrorWarning: {e.reason}")
...
if selected_layers:
    ...
    st.error("Please select one from above")
